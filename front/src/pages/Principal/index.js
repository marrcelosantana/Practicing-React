    ...
    return(
        <div className="principal-container">
            <div className="principal-box">
                <h1 className="titulo">CALCULADORA PVP</h1>
                ...
                <button className="entrar">
                    ...
                    <Link className = "goto" to = "/operations">
                        COMEÇAR
                    </Link>
                ...
                <div className="final">
                    ...
                    <div className="sociais">
                        <a className = 'instagram' href = "https://www.instagram.com/marrcelosantana" target="_blank">
                            <img src= { InstagramImg } alt = "Insta"/>
                        </a>

                        <div className="space"></div>

                        <a className = 'linkedin' href = "https://www.linkedin.com/in/marcelo-santana-0bab88208" target="_blank">
                            <img src= { LinkedinImg } alt = "Linkedin"/>
                        </a>

                        <div className="space"></div>

                        <a className = 'github' href = "https://github.com/marrcelosantana" target="_blank">
